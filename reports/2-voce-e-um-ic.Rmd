...
funcao_theta_pop = function(df) {
    ...
    return(cor(x = df$mediana_pop, y = df$proporcao_novos_artitas, method = "pearson"))
}
...
########################################################   
  ...
  # PORQUE NÃO CONSIGO AJUSTAR ESSE GRÁFICO?

########################################################   
reamostragens %>%
  ggplot(aes(x = theta_c_s)) +
  geom_histogram(binwidth = .000000000000005,
                 colour = "darkorange",
                 fill = "white")
...
# PQ NÃO DÁ PRA VISUALIZAR O INTERVALO DE CONFIANÇA?
